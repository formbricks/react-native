...
// ids
export const mockWorkspaceId = "ggskhsue85p2xrxrc7x3qagg";
/** @deprecated Kept for existing test imports — maps to `mockWorkspaceId`. */
export const mockEnvironmentId = mockWorkspaceId;
